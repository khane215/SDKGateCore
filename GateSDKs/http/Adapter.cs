    ...
    public class Adapter : IAdapterInterface
    {
        ...
        public IResponseInterface sendRequest(IRequestInterface request)
        {
            ...
            try
            {
                ...
                String jsonBatchEncode = JsonSerializer.Serialize(bodyParams);
                ...
                StreamReader reader =  new StreamReader(responseStream.GetResponseStream(), Encoding.UTF8);

                strResponse = reader.ReadToEnd().Trim();
